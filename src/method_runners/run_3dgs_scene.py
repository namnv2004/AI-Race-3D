...
Baseline (competition-stable):
    python src/method_runners/run_3dgs_scene.py --scene-dir data/round1/phase1/public_set/HCM0181 \\
        --output-dir outputs/smoke/3dgs_f2_10k --factor 2 --steps 10000

Mask-weighted (boost foreground BTS/tower region):
    python src/method_runners/run_3dgs_scene.py --scene-dir data/round1/phase1/public_set/HCM0181 \\
        --output-dir outputs/smoke/3dgs_mask_10k --factor 2 --steps 10000 \\
...
from mask_utils import load_mask, resolve_mask_path, weighted_l1_loss_map
